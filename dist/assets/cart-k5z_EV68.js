import{l as s,g as c}from"./utils-B7drxXma.js";s();function e(){const t=(c("so-cart")||[]).map(r=>o(r));document.querySelector(".product-list").innerHTML=t.join("")}function o(a){return`<li class="cart-card divider" data-id="${a.Id}">
